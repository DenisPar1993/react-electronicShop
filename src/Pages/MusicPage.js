                ...
                <div className="descr-title">Характеристики</div>
                   <div className="descr-wrap">
                       <div className="descr-wrap__item">
                           <div className="descr-name__item">Тип соединения:</div>
                           <div className="descr-value__item">{gadget.characteristics.connectionType}</div>
                       </div>
                       <div className="descr-wrap__item">
                           <div className="descr-name__item">Тип акустического оформления:</div>
                           <div className="descr-value__item">{gadget.characteristics.acousticType}</div>
                       </div>
                       <div className="descr-wrap__item">
                           <div className="descr-name__item">Подключение:</div>
                           <div className="descr-value__item">{gadget.characteristics.connection}</div>
                       </div>
                       <div className="descr-wrap__item">
                           <div className="descr-name__item">Время работы:</div>
                           <div className="descr-value__item">{gadget.characteristics.working}</div>
                       </div>
