    ...
    <div className='menu-fix'>
      <div className='container'>
        <div className="header-wrapper">
          <Link className='main-logo' to="/"><img src={logo} alt="" /></Link>
          ...
          <div className='basket-fav'>
            ...
            <Link className='header-cart' to="/basket"><img src={cart} alt="" />
              {count > 0 && <div className='header-count cart-header'>{count}</div>}
              <span className='header-tel__text'>Корзина</span></Link>
          </div>
        </div>
      </div>
